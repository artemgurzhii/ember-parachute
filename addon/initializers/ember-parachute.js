  ...
  Route.reopen({
    ...
    setupController(controller, model, transition) {
      ...
      if (QueryParams.hasParachute(controller)) {
        ...
        controller.setup && controller.setup(event, transition);
    ...
    resetController(controller, isExiting) {
      ...
      if (QueryParams.hasParachute(controller)) {
        ...
        controller.reset && controller.reset(event, isExiting);
    ...
    _scheduleParachuteChangeEvent(routeName, controller, changed = {}) {
      run.schedule('afterRender', this, () => {
        ...
        controller.queryParamsDidChange && controller.queryParamsDidChange(event);
